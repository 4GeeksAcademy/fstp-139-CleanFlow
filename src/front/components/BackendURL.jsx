...
export const BackendURL = () => (
	<div className="mt-5 pt-5 w-50 mx-auto">
		...
		<p>Here is a video tutorial on <a target="_blank" rel="noreferrer" href="https://www.awesomescreenshot.com/video/16498567?key=72dbf905fe4fa6d3224783d02a8b1b9c">how to update your backend URL environment variable.</a></p>
		<p>There is a file called <Dark>.env</Dark> that contains the environmental variables for your project.</p>
		<p>Ther is one variable called <Dark>BACKEND_URL</Dark> that needs to be manually set by yourself.</p>
		<ol>
