...
class Booking(db.Model):
    ...
    status: Mapped[Enum] = mapped_column(Enum(Booking), nullable=False)
...
class BookingTask(db.Model):
    ...
    status: Mapped[Enum] = mapped_column(Enum(BookingTask), nullable=False)
...
class Media(db.Model):
    ...
    media_type: Mapped[Enum] = mapped_column(Enum(Media), nullable=False)
